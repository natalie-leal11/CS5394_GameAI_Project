## Prompt Title: AI Director — per-update overhead
...
### OBJECTIVE ###
Director update cost per call stays under soft budget with N enemies.
...
- `tests/performance/test_ai_director_overhead.py`
...
### TEST CASES ###
- `test_director_update_cost_small`
- `test_director_update_cost_medium`
