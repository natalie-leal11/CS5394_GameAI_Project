## Prompt Title: RL env — step throughput
...
### OBJECTIVE ###
Headless DungeonEnv step throughput ≥ N steps/second under fixed seed.

---

### CONTEXT — EXISTING GAPS ###
Not covered by existing performance prompts.

---

### FILES TO CREATE OR EXTEND ###
- `tests/performance/test_rl_env_step_throughput.py`
...
### TEST CASES ###
- `test_headless_env_throughput_64_steps_under_budget`
- `test_headless_env_reset_under_budget`

---

### IMPLEMENTATION NOTES ###
- Soft threshold gated by env var `PERF_CI=1`.
...
### ACCEPTANCE ###
- All listed tests pass locally via `pytest tests/performance`.
