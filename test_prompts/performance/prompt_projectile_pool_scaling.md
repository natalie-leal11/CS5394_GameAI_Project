## Prompt Title: Performance — projectile pool scaling
...
### OBJECTIVE ###
100/500/1000 live projectiles still update within soft budget.

---

### FILES TO CREATE OR EXTEND ###
- `tests/performance/test_projectile_pool_scaling.py`
...
### TEST CASES ###
- `test_projectile_update_100`
- `test_projectile_update_500`
- `test_projectile_update_1000`
