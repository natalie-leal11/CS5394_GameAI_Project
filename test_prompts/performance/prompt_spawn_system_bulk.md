## Prompt Title: Performance — bulk spawn
...
### OBJECTIVE ###
Spawning N enemies at once does not exceed budget and has no per-call leak.

---

### FILES TO CREATE OR EXTEND ###
- `tests/performance/test_spawn_system_bulk.py`
...
### TEST CASES ###
- `test_bulk_spawn_budget`
- `test_bulk_spawn_memory_stable`
