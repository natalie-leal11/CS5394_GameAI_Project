## Prompt Title: Performance — asset loader cold start
...
### OBJECTIVE ###
Cold asset load of core assets completes under a soft budget (mocked IO).

---

### FILES TO CREATE OR EXTEND ###
- `tests/performance/test_asset_loader_startup.py`
...
### TEST CASES ###
- `test_cold_asset_load_budget`
- `test_warm_asset_load_faster_than_cold`
