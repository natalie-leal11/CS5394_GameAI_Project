## Prompt Title: Performance — game loop step timing
...
### OBJECTIVE ###
A single GameScene update step with N entities completes under a soft budget.

---

### FILES TO CREATE OR EXTEND ###
- `tests/performance/test_game_loop_timing.py`
...
### TEST CASES ###
- `test_update_step_under_budget_small`
- `test_update_step_under_budget_medium`

---

### IMPLEMENTATION NOTES ###
- Use `time.perf_counter`.
- Mark as `@pytest.mark.performance` so CI can opt-in/out.
- Soft thresholds; skip on slow CI via env var.
