## Prompt Title: Hazard system — tick cost
...
### OBJECTIVE ###
Hazard tick scales acceptably with hazard count (100/500/1000).
...
- `tests/performance/test_hazard_tick_cost.py`
...
### TEST CASES ###
- `test_hazard_tick_100`
- `test_hazard_tick_500`
- `test_hazard_tick_1000`
