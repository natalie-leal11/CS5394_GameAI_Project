## Prompt Title: Performance — collisions broadphase scaling
...
### OBJECTIVE ###
Broadphase cost grows sub-quadratically with entity count.

---

### FILES TO CREATE OR EXTEND ###
- `tests/performance/test_collisions_broadphase.py`
...
### TEST CASES ###
- `test_collision_cost_scales_sublinear_to_quadratic`
- `test_collision_no_pathological_case`
