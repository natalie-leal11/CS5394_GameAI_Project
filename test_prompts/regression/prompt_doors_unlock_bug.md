## Prompt Title: Regression — doors not opening after boss death
...
### OBJECTIVE ###
After boss death, door must unlock within the configured delay.

---

### FILES TO CREATE OR EXTEND ###
- `tests/regression/test_doors_unlock_bug.py`
...
### TEST CASES ###
- `test_door_unlocks_after_boss_death`
- `test_door_does_not_unlock_before_clear`
- `test_concurrent_death_and_damage_does_not_relock`
