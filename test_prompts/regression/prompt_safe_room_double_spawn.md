## Prompt Title: Regression — safe room double spawn
...
### OBJECTIVE ###
Safe rooms must never spawn enemies, even on re-entry.

---

### FILES TO CREATE OR EXTEND ###
- `tests/regression/test_safe_room_double_spawn.py`
...
### TEST CASES ###
- `test_safe_room_first_entry_no_spawn`
- `test_safe_room_reentry_no_spawn`
