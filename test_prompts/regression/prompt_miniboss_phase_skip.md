## Prompt Title: Regression — mini-boss phase skip on burst damage
...
### OBJECTIVE ###
Large single-frame damage must not skip phase transitions or their triggers.

---

### FILES TO CREATE OR EXTEND ###
- `tests/regression/test_miniboss_phase_skip.py`
...
### TEST CASES ###
- `test_burst_damage_triggers_all_phases`
- `test_phase_events_emitted_in_order`
