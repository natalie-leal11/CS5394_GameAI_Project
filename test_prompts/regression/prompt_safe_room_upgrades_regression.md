## Prompt Title: Safe room upgrades — regression pins (extends existing)
...
### OBJECTIVE ###
Extend existing file with regressions for: double-apply on re-entry, upgrade lost after respawn, hidden upgrade slot.

---

### CONTEXT — EXISTING GAPS ###
Existing file covers happy path only.

---

### FILES TO CREATE OR EXTEND ###
- `tests/regression/test_safe_room_upgrades.py`
...
### TEST CASES ###
- `test_upgrade_not_double_applied_on_reentry`
- `test_upgrade_retained_after_respawn`
- `test_no_hidden_upgrade_slot_leak`
