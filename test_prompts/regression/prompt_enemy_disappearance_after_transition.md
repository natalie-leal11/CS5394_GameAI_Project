## Prompt Title: Regression — enemies disappear after room transition
...
### OBJECTIVE ###
Transitioning rooms must NOT leak or duplicate enemies, and the new room's enemies must render.

---

### FILES TO CREATE OR EXTEND ###
- `tests/regression/test_enemy_disappearance_after_transition.py`
...
### TEST CASES ###
- `test_enemy_list_cleared_on_transition`
- `test_new_room_enemies_spawn_exactly_once`
- `test_no_leftover_enemy_references`
