## Prompt Title: Regression — checkpoint respawn state
...
### OBJECTIVE ###
Respawn at checkpoint preserves unlocked upgrades and lives counter.
...
### TEST CASES ###
- `test_respawn_keeps_upgrades`
- `test_respawn_decrements_lives`
- `test_respawn_resets_room_enemies`
