## Prompt Title: AI Director biomes — regression pins (extends existing)
...
### OBJECTIVE ###
Existing file is 18935 bytes. Pin regressions: director stuck in pacing state, difficulty downshift loop, biome boundary double-trigger.

---

### CONTEXT — EXISTING GAPS ###
No prompt currently regression-pins the director.

---

### FILES TO CREATE OR EXTEND ###
- `tests/regression/test_ai_director_biomes.py`
...
### TEST CASES ###
- `test_director_does_not_get_stuck_in_single_pacing_state`
- `test_director_downshift_does_not_oscillate`
- `test_biome_boundary_triggers_escalation_once`
