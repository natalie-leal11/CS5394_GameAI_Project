## Prompt Title: Movement system (`systems/movement.py`)
...
### OBJECTIVE ###
Velocity integration, collision-free movement, and boundary clamping.
...
- `test_boundary_clamps_position`
- `test_zero_velocity_no_update`
