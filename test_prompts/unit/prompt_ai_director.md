## Prompt Title: AI Director (`game/ai/ai_director.py`)
...
### OBJECTIVE ###
Director pacing rules: escalate on clear, downshift on player damage.
...
### TEST CASES ###
- `test_director_escalates_on_room_clear`
- `test_director_downshifts_on_high_damage`
- `test_director_state_bounded`
