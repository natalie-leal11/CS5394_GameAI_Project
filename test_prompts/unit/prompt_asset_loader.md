## Prompt Title: Asset loader (`game/asset_loader.py`)
...
### OBJECTIVE ###
Missing asset handling, cache hits, and idempotent loads.
...
### TEST CASES ###
- `test_missing_asset_returns_fallback_or_raises`
- `test_repeated_load_uses_cache`
- `test_clear_cache_forces_reload`
