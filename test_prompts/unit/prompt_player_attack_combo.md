## Prompt Title: Player — Attack combo and attack buffer
...
### OBJECTIVE ###
Tests for combo index advancement, combo reset on timeout, and short attack buffer honoring queued inputs.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_player_attack_combo.py`
...
### TEST CASES ###
- `test_attack_advances_combo_index`
- `test_combo_resets_after_timeout`
- `test_attack_buffer_queues_next_attack`
- `test_attack_cooldown_respected`
