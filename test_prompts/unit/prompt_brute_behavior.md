## Prompt Title: Brute enemy (`entities/brute.py`)
...
### OBJECTIVE ###
Verify charge wind-up, charge commit, and damage payload for Brute.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_brute_behavior.py`
...
### TEST CASES ###
- `test_brute_windup_duration`
- `test_brute_charges_toward_player_vector`
- `test_brute_damage_on_contact`
- `test_brute_recovery_after_charge`
