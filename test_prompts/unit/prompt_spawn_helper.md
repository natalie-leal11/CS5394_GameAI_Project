## Prompt Title: Spawn helper utilities (`systems/spawn_helper.py`)
...
### OBJECTIVE ###
Spawn point selection, distance constraints, and seeded reproducibility.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_spawn_helper.py`
...
- `test_seeded_spawn_is_reproducible`
- `test_no_spawn_inside_wall`
