## Prompt Title: Final boss (`entities/final_boss.py`)
...
### OBJECTIVE ###
Final boss multi-phase transition and terminal death flag.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_final_boss_phases.py`
...
### TEST CASES ###
- `test_final_boss_phase_progression`
- `test_final_boss_last_phase_unlocks_ultimate`
- `test_final_boss_terminal_once`
