## Prompt Title: Biome 3 mini-boss (`entities/biome3_miniboss.py`)
...
### OBJECTIVE ###
Biome 3 miniboss hazard spawn, hp and phase rules.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_biome3_miniboss.py`
...
### TEST CASES ###
- `test_biome3_miniboss_spawns_hazards`
- `test_biome3_miniboss_phase_thresholds`
- `test_biome3_miniboss_death_clears_hazards`
