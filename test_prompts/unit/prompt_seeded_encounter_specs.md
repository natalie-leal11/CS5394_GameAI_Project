## Prompt Title: Seeded encounter specs (`dungeon/seeded_encounter_specs.py`)
...
### OBJECTIVE ###
Seeded encounters are stable and match expected counts/types.
...
### TEST CASES ###
- `test_encounter_deterministic_per_seed`
- `test_encounter_composition_within_bounds`
- `test_same_room_same_seed_same_result`
