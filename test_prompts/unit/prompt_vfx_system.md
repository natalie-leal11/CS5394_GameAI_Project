## Prompt Title: VFX lifetime (`systems/vfx.py`)
...
### OBJECTIVE ###
VFX particle spawn, TTL decay, and cleanup from active list.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_vfx_system.py`
...
### TEST CASES ###
- `test_vfx_spawn_adds_to_list`
- `test_vfx_ttl_decays`
- `test_vfx_removed_when_ttl_zero`
