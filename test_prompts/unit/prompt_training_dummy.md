## Prompt Title: Training dummy (`entities/training_dummy.py`)
...
### OBJECTIVE ###
Dummy takes damage but never retaliates; resets on request.
...
### TEST CASES ###
- `test_dummy_takes_damage`
- `test_dummy_never_moves`
- `test_dummy_reset_restores_hp`
