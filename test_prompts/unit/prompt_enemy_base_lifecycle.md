## Prompt Title: EnemyBase — Lifecycle, damage, death (`entities/enemy_base.py`)
...
### OBJECTIVE ###
Test base enemy spawn, hp, damage, death flag, and drop/cleanup hooks.
...
### TEST CASES ###
- `test_enemy_hp_initialized_from_config`
- `test_enemy_dies_when_hp_zero`
- `test_death_sets_is_dead_flag_once`
- `test_damage_negative_values_rejected_or_clamped`
