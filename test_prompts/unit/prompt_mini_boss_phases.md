## Prompt Title: Mini boss phases (`entities/mini_boss.py`)
...
### OBJECTIVE ###
Test phase transitions driven by HP thresholds and ability unlocks per phase.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_mini_boss_phases.py`
...
### TEST CASES ###
- `test_phase_one_at_full_hp`
- `test_phase_transition_at_hp_threshold`
- `test_phase_two_unlocks_new_ability`
- `test_no_phase_regression_on_heal`
