## Prompt Title: Swarm enemy (`entities/swarm.py`)
...
### OBJECTIVE ###
Test swarm cohesion/separation behaviors and group target locking.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_swarm_behavior.py`
...
### TEST CASES ###
- `test_swarm_moves_toward_player`
- `test_swarm_maintains_min_separation`
- `test_swarm_member_removal_on_death`
