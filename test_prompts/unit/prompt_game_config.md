## Prompt Title: Game config sanity (`game/config.py`)
...
### OBJECTIVE ###
Required keys present, numeric ranges valid, no NaN defaults.
...
- `test_numeric_ranges_sane`
- `test_no_nan_or_none_defaults`
