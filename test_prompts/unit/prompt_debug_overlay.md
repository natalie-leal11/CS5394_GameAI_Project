## Prompt Title: Debug overlay (`game/debug/debug_overlay.py`) — new unit coverage
...
### OBJECTIVE ###
No existing tests. Cover toggle, line rendering list composition, and perf counter updates.

---

### CONTEXT — EXISTING GAPS ###
No test file and no prompt for debug_overlay.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_debug_overlay.py`
...
### TEST CASES ###
- `test_overlay_off_by_default`
- `test_toggle_enables_overlay`
- `test_lines_include_expected_keys_when_enabled`
- `test_fps_line_updates_on_tick`

---

### IMPLEMENTATION NOTES ###
- Mock draw surface; assert composed string list, not pixels.
