## Prompt Title: Metrics tracker (`game/ai/metrics_tracker.py`)
...
### OBJECTIVE ###
Rolling metrics accumulation (dps, hit rate, deaths).
...
- `test_rolling_window_drops_old`
- `test_reset_clears_all_keys`
