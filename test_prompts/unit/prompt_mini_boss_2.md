## Prompt Title: Mini boss 2 variant (`entities/mini_boss_2.py`)
...
### OBJECTIVE ###
Variant-specific phase behavior, distinct from `mini_boss.py`.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_mini_boss_2.py`
...
### TEST CASES ###
- `test_variant_hp_pool_distinct`
- `test_variant_phase_thresholds`
- `test_variant_unique_ability_fires`
