## Prompt Title: Phase 1 seed debug (`game/phase1_seed_debug.py`) — new unit coverage
...
### OBJECTIVE ###
No existing tests. Ensure debug helper yields stable output and never mutates shared state.

---

### CONTEXT — EXISTING GAPS ###
No test file and no prompt for phase1_seed_debug.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_phase1_seed_debug.py`
...
### TEST CASES ###
- `test_seed_debug_output_stable_for_same_seed`
- `test_seed_debug_varies_across_seeds`
- `test_seed_debug_does_not_mutate_global_rng`

---

### IMPLEMENTATION NOTES ###
- Snapshot global RNG state before/after the call.
