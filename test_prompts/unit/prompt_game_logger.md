## Prompt Title: Game logger (`game/logger.py`) — new unit coverage
...
### OBJECTIVE ###
No existing tests. Cover level filtering, formatter output, and handler dispatch.

---

### CONTEXT — EXISTING GAPS ###
No test file and no prompt for game/logger.py.
...
### TEST CASES ###
- `test_logger_respects_level`
- `test_logger_format_includes_timestamp_or_level`
- `test_handler_receives_record_when_above_level`
- `test_logger_suppressed_when_disabled`

---

### IMPLEMENTATION NOTES ###
- Use an in-memory handler (subclass of `logging.Handler`).
