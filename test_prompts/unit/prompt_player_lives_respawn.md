## Prompt Title: Player — Lives counter and respawn transitions
...
### OBJECTIVE ###
Test life decrement on death, respawn restores HP, and last-life → game over.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_player_lives_respawn.py`
...
### TEST CASES ###
- `test_life_decrement_on_death`
- `test_respawn_restores_full_hp`
- `test_last_life_death_sets_game_over_flag`
- `test_respawn_resets_invuln_timer`

---

### IMPLEMENTATION NOTES ###
- Stub scene interactions; use plain `Player` instance.
- Assert terminal flag exactly once per death.
