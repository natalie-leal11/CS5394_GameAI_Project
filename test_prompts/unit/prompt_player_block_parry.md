## Prompt Title: Player — Block and parry
...
### OBJECTIVE ###
Unit tests for block damage reduction, parry window, parry success/failure, and mutual exclusion with attack state.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_player_block_parry.py`
...
- `test_parry_window_is_bounded`
- `test_successful_parry_flags_stagger_intent`
- `test_block_and_attack_mutually_exclusive`
