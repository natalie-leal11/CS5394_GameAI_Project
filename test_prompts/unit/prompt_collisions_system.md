## Prompt Title: Collisions (`systems/collisions.py`)
...
### OBJECTIVE ###
AABB overlap, player–enemy, projectile–enemy, and wall collisions.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_collisions_system.py`
...
### TEST CASES ###
- `test_aabb_overlap_true_false`
- `test_player_enemy_collision_fires_event`
- `test_projectile_wall_collision_despawns`
- `test_no_self_collision_same_entity`
