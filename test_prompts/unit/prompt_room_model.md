...
### OBJECTIVE ###
Room geometry, door slots, spawn slots, and cleared flag semantics.
...
### TEST CASES ###
- `test_room_has_expected_door_count`
- `test_spawn_slots_inside_bounds`
- `test_cleared_flag_only_when_no_enemies`
