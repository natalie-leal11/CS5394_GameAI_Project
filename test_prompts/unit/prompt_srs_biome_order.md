## Prompt Title: SRS biome order (`dungeon/srs_biome_order.py`) — new unit coverage
...
### OBJECTIVE ###
No existing tests. Cover the deterministic biome-order sequence, bounds, and reset.

---

### CONTEXT — EXISTING GAPS ###
No test file and no prompt for srs_biome_order.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_srs_biome_order.py`
...
### TEST CASES ###
- `test_srs_sequence_length_matches_biome_count`
- `test_srs_sequence_no_duplicates`
- `test_srs_reset_returns_to_first_biome`
- `test_srs_sequence_deterministic_under_seed`
