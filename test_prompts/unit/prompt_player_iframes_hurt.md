## Prompt Title: Player — Hurt state and i-frames
...
### OBJECTIVE ###
Ensure post-damage invulnerability prevents double-hits in same frame and decays correctly.

---

### FILES TO CREATE OR EXTEND ###
- `tests/unit/test_player_iframes_hurt.py`
...
### TEST CASES ###
- `test_iframes_block_second_hit_same_frame`
- `test_iframes_decay_over_time`
- `test_hurt_state_clears_after_duration`
...
- Multiple damage events in the same tick resolve once.
