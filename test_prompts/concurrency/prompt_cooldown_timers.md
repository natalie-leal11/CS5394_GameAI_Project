## Prompt Title: Cooldown / timing primitives under tick churn
...
### OBJECTIVE ###
Dash, attack, parry, block timers tick exactly once per update regardless of order.

---

### FILES TO CREATE OR EXTEND ###
- `tests/concurrency/test_cooldown_timers.py`
...
### TEST CASES ###
- `test_timer_ticks_once_per_update`
- `test_timer_never_negative`
- `test_multiple_timers_independent`
...
- Timer update order irrelevant to final values.
