## Prompt Title: Biome 2 mini-boss encounter (`dungeon/biome2_mini_boss_encounter.py`)
...
### OBJECTIVE ###
No existing test targets this module directly. Cover setup, phase events, and door-unlock on death.

---

### CONTEXT — EXISTING GAPS ###
Source file exists; no test / prompt yet.

---

### FILES TO CREATE OR EXTEND ###
- `tests/integration/test_biome2_mini_boss_encounter.py`
...
### TEST CASES ###
- `test_biome2_encounter_spawns_miniboss`
- `test_biome2_encounter_phase_events_in_order`
- `test_biome2_encounter_door_unlock_on_death`
