## Prompt Title: Safe room upgrades — integration depth (extends test_safe_room_upgrades)
...
### OBJECTIVE ###
Existing file exists (7001 bytes). Add integration depth: upgrade persists across room transitions, stacks correctly, and interacts with checkpoint.

---

### CONTEXT — EXISTING GAPS ###
`GameScene safe room` skip in generator.

---

### FILES TO CREATE OR EXTEND ###
- `tests/integration/test_safe_room_upgrades_integration.py`
...
### TEST CASES ###
- `test_upgrade_persists_across_2_rooms`
- `test_upgrades_stack_additively`
- `test_checkpoint_respawn_preserves_upgrades_chosen_so_far`
