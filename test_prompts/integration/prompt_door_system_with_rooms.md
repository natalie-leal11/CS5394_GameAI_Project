## Prompt Title: Doors + rooms integration (`dungeon/door_system.py`)
...
### OBJECTIVE ###
Doors locked in combat, unlock delay, and traversal re-locks as expected.

---

### FILES TO CREATE OR EXTEND ###
- `tests/integration/test_door_system_with_rooms.py`
...
### TEST CASES ###
- `test_doors_locked_during_combat`
- `test_doors_unlock_after_clear_with_delay`
- `test_traversal_advances_room_index`
