## Prompt Title: SpawnSystem + RoomController (`systems/spawn_system.py`)
...
### OBJECTIVE ###
Spawn respects room slots, difficulty scaling, and seeded reproducibility.
...
### TEST CASES ###
- `test_spawn_respects_slots`
- `test_spawn_scales_with_difficulty`
- `test_spawn_seeded_reproducible`
