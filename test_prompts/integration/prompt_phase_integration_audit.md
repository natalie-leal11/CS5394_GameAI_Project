## Prompt Title: Phase test files — integration audit (phase1–7)
...
### OBJECTIVE ###
The `test_phase{1..7}_*.py` files are large integration tests at the repo root. Audit cross-phase invariants: shared fixtures, consistent imports, no cross-test state leakage.

---

### CONTEXT — EXISTING GAPS ###
No current prompt references phase test files.

---

### FILES TO CREATE OR EXTEND ###
- `tests/integration/test_phase_integration_audit.py`
...
### TEST CASES ###
- `test_phase_files_do_not_share_mutable_module_state`
- `test_phase_files_use_conftest_fixtures_consistently`
- `test_phase_files_run_independently_in_any_order`
- `test_phase_files_no_network_or_disk_side_effects`

---

### IMPLEMENTATION NOTES ###
- Use `pytest-randomly`-style shuffling manually via `pytest.main([...])` in a subprocess OR assert module-level flags stay pristine.
