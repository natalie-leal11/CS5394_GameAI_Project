## Prompt Title: Biome 3 and final boss flows
...
### OBJECTIVE ###
End-to-end boss flow with mocked scene: phase progression → death → victory.

---

### FILES TO CREATE OR EXTEND ###
- `tests/integration/test_boss_flows.py`
...
### TEST CASES ###
- `test_biome3_boss_flow_to_death`
- `test_final_boss_flow_to_victory`
- `test_victory_transitions_scene`
