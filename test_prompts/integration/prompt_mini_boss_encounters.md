## Prompt Title: Mini-boss encounters in rooms
...
### OBJECTIVE ###
Biome 2 mini-boss encounter, phase progression in-room, and door unlock on death.

---

### FILES TO CREATE OR EXTEND ###
- `tests/integration/test_mini_boss_encounters.py`
...
### TEST CASES ###
- `test_biome2_miniboss_encounter_loads`
- `test_miniboss_phase_progresses_in_room`
- `test_doors_unlock_on_miniboss_death`
