## Prompt Title: AI logger integration hooks
...
### OBJECTIVE ###
AI logger receives events from director and metrics tracker during a fake run.

---

### FILES TO CREATE OR EXTEND ###
- `tests/integration/test_ai_logger_hooks.py`
...
### TEST CASES ###
- `test_logger_receives_director_events`
- `test_logger_receives_metrics_events`
- `test_logger_flush_on_room_transition`
