## Prompt Title: Biome director spawn hooks (`game/ai/biome{1..4}_director_spawn.py`)
...
### OBJECTIVE ###
Each biome director spawns the expected set of enemies under fixed seed.
...
### TEST CASES ###
- `test_biome1_director_spawn_composition`
- `test_biome2_director_spawn_composition`
- `test_biome3_director_spawn_composition`
- `test_biome4_director_spawn_composition`
