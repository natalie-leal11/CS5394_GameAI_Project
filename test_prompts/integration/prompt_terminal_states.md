## Prompt Title: GameScene terminal states (death / victory)
...
### OBJECTIVE ###
Death → game over scene; victory → credits/end scene; state not double-emitted.

---

### FILES TO CREATE OR EXTEND ###
- `tests/integration/test_terminal_states.py`
...
### TEST CASES ###
- `test_player_death_transitions_to_game_over`
- `test_victory_transitions_to_end`
- `test_terminal_fires_once`
