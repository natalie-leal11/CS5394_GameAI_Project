## Prompt Title: Gameplay metrics hooks across systems
...
### OBJECTIVE ###
Metrics tracker sees damage, kills, room clears from integrated systems.
...
### TEST CASES ###
- `test_damage_events_counted`
- `test_kill_events_counted`
- `test_room_clear_counted_once`
