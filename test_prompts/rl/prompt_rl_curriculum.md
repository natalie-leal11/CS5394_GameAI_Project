## Prompt Title: RL — Curriculum wrappers & layout (`rl/curriculum_wrappers.py`, `rl/curriculum_layout.py`)
...
### OBJECTIVE ###
Curriculum stages advance on success criteria; layout is self-consistent.
...
### TEST CASES ###
- `test_stage_advances_on_success`
- `test_stage_does_not_regress`
- `test_curriculum_layout_keys_consistent`
