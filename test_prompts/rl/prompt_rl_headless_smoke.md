## Prompt Title: RL — Headless smoke (`rl/headless.py`, `rl/test_env.py`)
...
### OBJECTIVE ###
Headless env runs a few steps end-to-end with no rendering and stable shapes.

---

### FILES TO CREATE OR EXTEND ###
- `tests/rl/test_rl_headless_smoke.py`
...
### TEST CASES ###
- `test_headless_few_steps_runs`
- `test_headless_step_shapes_stable`
- `test_headless_terminates_on_done`

---

### IMPLEMENTATION NOTES ###
- Hard-cap steps at 32.
- Fixed seed. No training.
