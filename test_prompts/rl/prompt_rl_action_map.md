## Prompt Title: RL — Action map (`rl/action_map.py`)
...
### OBJECTIVE ###
Discrete / multi-discrete mapping to controls is total and injective on valid range.
...
### TEST CASES ###
- `test_action_total_coverage`
- `test_action_injective_on_valid_range`
- `test_action_out_of_range_rejected_or_clamped`
