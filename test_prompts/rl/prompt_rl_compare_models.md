## Prompt Title: `rl/compare_ppo_models.py` — smoke
...
### OBJECTIVE ###
No tests target `compare_ppo_models.py`. Verify summary aggregation on fake per-model stats dicts.
...
- `tests/rl/test_rl_compare_models.py`
...
### TEST CASES ###
- `test_compare_models_aggregates_mean_and_std`
- `test_compare_models_handles_single_model`
- `test_compare_models_empty_input_raises_or_empty_summary`
