## Prompt Title: RL — Env wrappers (`rl/wrappers.py`)
...
### OBJECTIVE ###
Flatten / normalize / frame-stack wrappers preserve semantics; reset composes.

---

### FILES TO CREATE OR EXTEND ###
- `tests/rl/test_rl_wrappers.py`
...
### TEST CASES ###
- `test_flatten_wrapper_preserves_info`
- `test_normalize_wrapper_stats_update`
- `test_framestack_wrapper_shape`
