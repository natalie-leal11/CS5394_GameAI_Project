## Prompt Title: RL — Reward breakdown (`rl/reward.py`)
...
### OBJECTIVE ###
Components sum to step reward; terminal reward paid once; stall penalty triggers at threshold.
...
### TEST CASES ###
- `test_components_sum_to_step_reward`
- `test_terminal_reward_paid_once`
- `test_stall_penalty_threshold`
- `test_reset_boundary_reward_zero`
