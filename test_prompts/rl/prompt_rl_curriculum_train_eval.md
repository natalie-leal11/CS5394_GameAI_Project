## Prompt Title: `rl/train_curriculum_ppo.py` + `rl/eval_curriculum.py` — smoke
...
### OBJECTIVE ###
No tests target the curriculum train/eval scripts. Add arg-parse + dry-run smoke for both.

---

### CONTEXT — EXISTING GAPS ###
Uncovered RL scripts.

---

### FILES TO CREATE OR EXTEND ###
- `tests/rl/test_rl_curriculum_train_eval.py`
...
### TEST CASES ###
- `test_train_curriculum_ppo_argparser`
- `test_train_curriculum_ppo_dry_run_creates_stage_dirs`
- `test_eval_curriculum_argparser`
- `test_eval_curriculum_missing_stages_raises_clear_error`
