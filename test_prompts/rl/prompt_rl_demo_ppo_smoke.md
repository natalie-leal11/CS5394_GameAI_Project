## Prompt Title: `rl/demo_ppo.py` — smoke
...
### OBJECTIVE ###
No tests target `demo_ppo.py`. Add arg-parsing smoke and graceful exit on missing model.
...
- `tests/rl/test_rl_demo_ppo_smoke.py`
...
### TEST CASES ###
- `test_demo_ppo_argparser_parses_defaults`
- `test_demo_ppo_missing_model_returns_nonzero_or_raises`
- `test_demo_ppo_respects_max_steps_flag`
