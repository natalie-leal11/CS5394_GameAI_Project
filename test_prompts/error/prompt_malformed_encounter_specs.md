## Prompt Title: Error — malformed encounter specs
...
### OBJECTIVE ###
Bad keys, missing enemy types, or negative counts are surfaced clearly.

---

### FILES TO CREATE OR EXTEND ###
- `tests/error/test_malformed_encounter_specs.py`
...
### TEST CASES ###
- `test_missing_enemy_type_raises`
- `test_negative_count_raises`
- `test_unknown_room_id_raises`
