## Prompt Title: Error — invalid `game/config.py` values
...
### OBJECTIVE ###
Out-of-range, negative, or NaN values are rejected or clamped; errors are informative.

---

### FILES TO CREATE OR EXTEND ###
- `tests/error/test_invalid_config.py`
...
### TEST CASES ###
- `test_negative_hp_rejected`
- `test_nan_value_rejected`
- `test_unknown_key_ignored_or_warns`
