## Prompt Title: Reward eval — error paths
...
### OBJECTIVE ###
Missing columns, non-numeric values, and empty trajectories surface clear errors.

---

### CONTEXT — EXISTING GAPS ###
`reward_eval` skipped twice; no error coverage.

---

### FILES TO CREATE OR EXTEND ###
- `tests/error/test_reward_eval_errors.py`
...
### TEST CASES ###
- `test_reward_eval_missing_column_raises`
- `test_reward_eval_non_numeric_value_raises`
- `test_reward_eval_empty_trajectory_returns_zero_or_raises`
