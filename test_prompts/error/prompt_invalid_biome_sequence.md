## Prompt Title: Error — invalid biome sequence
...
### OBJECTIVE ###
Gaps, duplicates, or unknown room ids in biome sequence files are detected.

---

### FILES TO CREATE OR EXTEND ###
- `tests/error/test_invalid_biome_sequence.py`
...
### TEST CASES ###
- `test_gap_in_sequence_detected`
- `test_duplicate_room_detected`
- `test_unknown_room_detected`
