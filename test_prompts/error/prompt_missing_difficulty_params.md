## Prompt Title: Error — missing difficulty params file
...
### OBJECTIVE ###
If the params file is absent or malformed, load falls back to defaults and logs a clear error.

---

### FILES TO CREATE OR EXTEND ###
- `tests/error/test_missing_difficulty_params.py`
...
- `test_malformed_file_raises_clear_error`
