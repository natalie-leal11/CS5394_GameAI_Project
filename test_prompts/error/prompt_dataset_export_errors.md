## Prompt Title: Dataset export — error paths
...
### OBJECTIVE ###
Malformed trajectories, unwritable paths, and mismatched schemas raise clear errors.

---

### CONTEXT — EXISTING GAPS ###
`dataset_export integration` skipped; no error coverage.

---

### FILES TO CREATE OR EXTEND ###
- `tests/error/test_dataset_export_errors.py`
...
### TEST CASES ###
- `test_export_to_unwritable_path_raises`
- `test_export_with_mismatched_schema_raises`
- `test_export_empty_trajectory_returns_empty_or_raises_clearly`
