## Prompt Title: Error — SceneManager unknown scene id
...
### OBJECTIVE ###
Requesting an unknown scene raises a clear error and does not mutate state.

---

### FILES TO CREATE OR EXTEND ###
- `tests/error/test_scene_manager_unknown_scene.py`
...
### TEST CASES ###
- `test_unknown_scene_id_raises`
- `test_state_unchanged_on_error`
