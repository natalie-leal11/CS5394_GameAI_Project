# Adaptive AI Dungeon - Requirements Analysis (Biome 2)
...
8. Biome 2 - Structure, Difficulty, Curve, Visual Identity
9. Biome 2 - Rooms (Templates + Safe Zones + Anchors)
10 Biome 2 - Hazards (Placement + Damage
+ Slow)
11. Biome 2 - Spawning System (Telegraphs + Portal FX)
12. Biome 2 - Enemy Composition (Hard Caps Per Room Type)
13. Combat System (Player + Enemy Ranges + Timing)
14. Room Clear Rule (Hard-Locked)
15. AI Director (Flexible Slot Rule + Bounds)
16. Logging for RL (JSONL Contract)
17. Optional LLM Features (Story Generation)
18. Determinism & Seeds (No seed display)
19. Open Items / Asset TODO Checklist
...
- MVP scope: full UI start flow and complete Biome 2.
...
# Requirements Analysis - Game start to Room 8 (UI + Assets + Propmts)
...
- Do not backe story text into PNGs.
...
Main Menu buttons are their behaviors:

- **Play**
    - Starts a new run and transitions into Room 8.
- **Controls**
...
- Mouse click activates selected manu option.
...
## 8) Transition from Story Intro to Room 8

### 8.1 Transition
After "Press any key""
- Fade into gameplay
- Player spawns in **Room 8**
...
- `assets/entities/enemies/heavy/attack_hit/frame_01.png`
- `assets/entities/enemies/heavy/attack_hit/frame_02.png`
- `assets/entities/enemies/heavy/attack_hit/frame_03.png`
- `assets/entities/enemies/heavy/attack_windup/frame_01.png`
- `assets/entities/enemies/heavy/attack_windup/frame_02.png`
- `assets/entities/enemies/heavy/attack_windup/frame_03.png`
- `assets/entities/enemies/heavy/death/frame_01.png`
- `assets/entities/enemies/heavy/death/frame_02.png`
- `assets/entities/enemies/heavy/death/frame_03.png`
- `assets/entities/enemies/heavy/hit/frame_01.png`
- `assets/entities/enemies/heavy/idle/frame_01.png`
- `assets/entities/enemies/heavy/idle/frame_02.png`
- `assets/entities/enemies/heavy/walk/frame_01.png`
- `assets/entities/enemies/heavy/walk/frame_02.png`
- `assets/entities/enemies/heavy/walk/frame_03.png`
- `assets/entities/enemies/mini_boss_1/attack_01/frame_01.png`
- `assets/entities/enemies/mini_boss_1/attack_01/frame_02.png`
- `assets/entities/enemies/mini_boss_1/attack_01/frame_03.png`
- `assets/entities/enemies/mini_boss_1/attack_01/frame_04.png`
- `assets/entities/enemies/mini_boss_1/attack_02/frame_01.png`
- `assets/entities/enemies/mini_boss_1/attack_02/frame_02.png`
- `assets/entities/enemies/mini_boss_1/attack_02/frame_03.png`
- `assets/entities/enemies/mini_boss_1/attack_02/frame_04.png`
- `assets/entities/enemies/mini_boss_1/dash/frame_01.png`
- `assets/entities/enemies/mini_boss_1/dash/frame_02.png`
- `assets/entities/enemies/mini_boss_1/dash/frame_03.png`
- `assets/entities/enemies/mini_boss_1/dash/frame_04.png`
- `assets/entities/enemies/mini_boss_1/death/frame_01.png`
- `assets/entities/enemies/mini_boss_1/death/frame_02.png`
- `assets/entities/enemies/mini_boss_1/death/frame_03.png`
- `assets/entities/enemies/mini_boss_1/death/frame_04.png`
- `assets/entities/enemies/mini_boss_1/death/frame_05.png`
- `assets/entities/enemies/mini_boss_1/death/frame_06.png`
- `assets/entities/enemies/mini_boss_1/death/frame_07.png`
- `assets/entities/enemies/mini_boss_1/death/frame_08.png`
- `assets/entities/enemies/mini_boss_1/death/frame_09.png`
- `assets/entities/enemies/mini_boss_1/death/frame_10.png`
- `assets/entities/enemies/mini_boss_1/hit/frame_01.png`
- `assets/entities/enemies/mini_boss_1/hit/frame_02.png`
- `assets/entities/enemies/mini_boss_1/idle/frame_01.png`
- `assets/entities/enemies/mini_boss_1/idle/frame_02.png`
- `assets/entities/enemies/mini_boss_1/idle/frame_03.png`
- `assets/entities/enemies/mini_boss_1/idle/frame_04.png`
- `assets/entities/enemies/mini_boss_1/move/frame_01.png`
- `assets/entities/enemies/mini_boss_1/move/frame_02.png`
- `assets/entities/enemies/mini_boss_1/move/frame_03.png`
- `assets/entities/enemies/mini_boss_1/move/frame_04.png`
- `assets/entities/enemies/mini_boss_1/move/frame_05.png`
- `assets/entities/enemies/mini_boss_1/move/frame_06.png`
- `assets/entities/enemies/mini_boss_1/phase_change/frame_01.png`
- `assets/entities/enemies/mini_boss_1/phase_change/frame_02.png`
- `assets/entities/enemies/mini_boss_1/phase_change/frame_03.png`
- `assets/entities/enemies/mini_boss_1/phase_change/frame_04.png`
- `assets/entities/enemies/mini_boss_1/phase_change/frame_05.png`
- `assets/entities/enemies/mini_boss_1/phase_change/frame_06.png`
- `assets/entities/enemies/mini_boss_1/windup/frame_01.png`
- `assets/entities/enemies/mini_boss_1/windup/frame_02.png`
- `assets/entities/enemies/mini_boss_1/windup/frame_03.png`
- `assets/entities/enemies/mini_boss_1/windup/frame_04.png`
- `assets/entities/enemies/mini_boss_2/attack/frame_01.png`
- `assets/entities/enemies/mini_boss_2/attack/frame_02.png`
- `assets/entities/enemies/mini_boss_2/attack/frame_03.png`
- `assets/entities/enemies/mini_boss_2/attack/frame_04.png`
- `assets/entities/enemies/mini_boss_2/attack/frame_05.png`
- `assets/entities/enemies/mini_boss_2/attack/frame_06.png`
- `assets/entities/enemies/mini_boss_2/death/frame_01.png`
- `assets/entities/enemies/mini_boss_2/death/frame_02.png`
- `assets/entities/enemies/mini_boss_2/death/frame_03.png`
- `assets/entities/enemies/mini_boss_2/death/frame_04.png`
- `assets/entities/enemies/mini_boss_2/hit/frame_01.png`
- `assets/entities/enemies/mini_boss_2/idle/frame_01.png`
- `assets/entities/enemies/mini_boss_2/idle/frame_02.png`
...
## 8) Biome 2 - Structure, Difficulty Curve, Visual Identify

### 9.1 Difficulty Curve (Mathematically Locked Baseline)

Biome 2 must follow a bounded difficulty slope. Seed may reorder within allowed skeleton, but the intensity budget must follow this curve. 

**Intensity scale:** `I ∈ {2,3,4,5,6,7}`
...
### 9.2 Visual Identity Lock (Biome 2)
...
## 10-14) Biome 2 Gameplay Specs (Rooms, Hazards, Spawns, Enemies, Combat)

# BIOME 2 - STRUCTURE & HAZARD LOCK (Phase 1)

Biome 2 = Rooms 8-15
Total Rooms in Biome = 8
...
## 1) Room Type Distribution (Biome 2)
...
- Room 15 = Mini Boss (fixed)
- Safe Room cannot be Room 8
- Safe Room cannot be Room 14
- Ambush cannot be Room 8
...
## 3) Hazard Percentages (Biome 2 Only)

Biome 2 is mid hazard
...
- Lva never blocks exit tile.
- At least one 3x3 fully safe zone exists.
...
Damage: 7 HP per second (Biome 2 reduced)
...
Purpose:
- Teaches positioning.
- Not meant to kill player in Biome 2.
- Punishment, not death trap.

---

### Slow Teerrain (Mud/Water)
...
## 5) Hazard Placement Philosoophy

Biome 2 hazards must:
...
## 6) RL Boundaries (Biome 2)

RL may later tune:
- Enemy count multiplier
- Ambush probability (within 2 room limit)
- Elite strength slightly

RL may NOT:
- Increase lava percentage above 10%
- Increase slow terrain above 15%
- Add reinforcement waves
- Add additional ambush rooms
- Remove Safe Room

Biome 2 structure is fixed.

# BIOME 2 - Procedural Hazard Placement (Validated System)

Hazards in Biome 2 are procedurally generated using seeded RNG.
All placements must pass validation checks before the room is accepted. 

Hazards are obstacles, not lethal traps. 
...
Biome 2 cap: 0-10% of room tiles.

For 12x12 (144 tiles):
Max lava tiles = 14.

Placement Rules:
- Lava clusters of 1-4 tiles.
- Max 3 clusters. 
- Clusters must:
  - Not touch spawn tile.
  - Not touch exit tile.
  - Not create narrow choke. 
  - Not appear inside guaranteed 3x3 safe zone.
...
- At least one 3x3 fully clear area.
- Usually centtered near player spawn.
- No hazards.
- No wall segments.
...
2. Run flood-fill or A* for spawn tile.
3. Confirm exit reachable.
4. Confirm safe zone reachable.
5. Confirm not fully isolateed hazard pockets.
...
# BIOME 2 - Procedural Hazard Plcament System (Room-Tyoe Aware + RL-Tunable)

Biome Hazards are:

- Procedurally generated
- Seed-deterministic
- Validated after plcament
...
# 1) GLOBAL CONSTRAINTS (Hard Locks - RL Cannot Change)

These rules must always hold in Biome 2:

1. Player spawn tile is safe.
2. Exit tile is safe.
3. At least one 3x3 fully safe zone exists.
4. Valid path from spawn -> exit must exit.
5. Lava cannot fully block corridor.
6. Hazards cannot create 1-tile choke traps.
7. No hazard may spawn on reserved spawn anchors.
8. Safe Room has 0% lava (non0negotiable).

These are engine-level guarantees.

# 2) RL-TUNABLE HAZARD RANGES (Biome 2 Bounds)
...
---
 ...
 # 3) Room-Type Specific Hazard Rules (Biome 2)

 Hazards are placed AFTER room type is known.

 ---

 ## 3.1 Standard Combat Room (12x12)

 Purpose: Combat enemies
 ...
 - Lava cluster: 1-4 tiles per cluster.
- Max 3 clusters.
- Prefer edges/corners.
- Avoid central spawn region.

- Slow terrain:
  - 2x2 patches preferred.
  - May influence mid-lane movement.
  - Must not block 3x3 safe zone.
...
RL may adjust within bounds, but cannot reduce safe area below 65%.
...
# 5) Lava Mechanics (Biome 2)

Damage: 7 HP per second
...
Purpose: obstacles, not lethal punishment.
...
# BIOME 2 — Door Rules + Spawn Anchor Selection (Deterministic)
...
4. If not enough anchors:
   - reduce N to number selected (Biome 2 safety)
...
#### Combat Room
- Spawn instantly when doors lock (no telegraph for Biome 2 combat).
...
🔴 TELEGRAPH VISUAL STANDARD (Biome 2 Baseline)
...
Timing (LOCKED VALUES for Biome 2):
...
Ambush must feel slightly more dramatic but still fair in Biome 2.
...
# BIOME 2 - Enemy Composition Rules (Per Room Type, RL-Tunable)

Goal (Biome 2):
- Execute combat learned during Biome 2. 
- Handle more overwhelming ambushes.
- Increase difficulty of encounters but maintain fairness.
- Allow RL to tune counts/composition later within strict bounds.

Terminology:
- **Melee**: chases player + short-range hit
- **Brutes**: slow walking + strong attacks
...
## Global Composition Constraints (Biome 2)
...
- Max simultaneous enemies on screen (Biome 2 cap): **6**

### Archetype caps (Biome 2 cap)
- Max ranged enemies at once: **2**
- Max “fast flankers” at once: **2**
- Elite room may include max **1 elite** (always exactly 1 in Biome 2)
- No summoning behavior in Biome 2 (elite + mini boss do NOT summon yet)
...
**Pattern 3 (Heavy supported)**
- 3× Fast Flanker
- 1× Heavy

### RL bounds (Combat)
RL may tune total enemies to: **4–6**
RL may tune ranged count to: **0–1** (Combat rooms only)
RL may tune flanker count to: **0–2**

---

## C) Ambush Room (8×8) — 2 rooms total

Purpose:
- Telegraph awareness + repositioning.

### Baseline enemy counts
- Total enemies: **4–5**
- Spawn as a single wave (Biome 2) with ambush telegraph.
...
### RL bounds (Ambush)
RL may tune total enemies to: **4–5**
RL may tune ranged count to: **0–1**
RL may tune flanker count to: **2–3** (small room fairness)
...
### Baseline composition
- 1× Mini Boss (Biome 2 Guardian)
- Add 2 enemies once boss reach 25 HP:
  - 1x Melee Grunt
  - 1x Brute
...
## Difficulty Ramp Within Biome 2 (Suggested)
Combat Room 1: 4–5 enemies, 0 ranged
Combat Room 2: 5 enemies, 0–1 ranged
Combat Room 3: 5–6 enemies, allow 1 ranged
Elite Room: elite + 2–3 supports
Mini Boss: boss + 0-2 adds
...
# BIOME 2 — Enemy Engage Distances + Attack Ranges (Locked Specs)
...
- Never more than **2 flankers alive** in Biome 2 (composition cap).
...
- Max ranged alive at once: **2** (Biome 2 cap).

---

## 3.4 Brute Enemy (slow + aggressive)
...
|---|---|
| Attack trigger distance | ≤ 1.0 tile (32 px) |
| Attack range | 1.5 tiles (35 px) |
| Wind-up | 1.0 sec |
| Active frames | 0.08 sec |
| Recovery | 0.35 sec |
| Attack cooldown | 2.0 sec |

Behavior: 
- If within trigger distance → start wind-up.
- If player dashes away during wind-up → attack can whiff (good fairness).
- Uses simple pathing to close distance; does not strafe.

---

## 3.5 Heavy Armored (strong + aggressive)
...
| Attribute | Value |
|---|---|
| Attack trigger distance | ≤ 2.0 tile (64 px) |
| Attack range | 3 tiles (70px) |
| Area of Effect | 70 px | 
| Wind-up | 0.35 sec |
| Active frames | 0.08 sec |
| Recovery | 0.35 sec |
| Attack cooldown | 3.0 sec |

Behavior: 
- If within trigger distance → start wind-up.
- If player dashes away from AoE → attack can whiff (good fairness).


---

## 3.6 Elite Guardian (Elite Room)
...
### Attacks (2-move kit for Biome 2)
...
## 3.7 Mini Boss (Biome 2 Guardian) — Baseline Kit
...
MVP rule:
- No summons in Biome 2.
- 2 adds in Biome 2 once HP recahes 25.
...
- No random wind-up/cooldown variance in Biome 2.
...
# BIOME 2 — Enemy Movement Speeds + Steering Rules (LOCKED, RL-Tunable)
...
## 1) Movement Speeds (Biome 2 Baseline)

These match the Proposal + Parameter tables and are the baseline for Biome 2.  
...
| Final Boss (Biome 4 reference) | 140 | 4.38 | (not used in Biome 2) |
...
- Mini boss speed is set to 140 px/sec for Biome 2 guardian to align with “boss class” pacing while remaining fair. :contentReference[oaicite:5]{index=5}

---

## 2) Steering Model (Simple + Deterministic)

Biome 2 uses **velocity steering** with **no random jitter**.
...
### 3.2 Separation strength (Biome 2 baseline)
...
## 6) Hazard Interaction Movement Rules (Biome 2)
...
- If crossing lava is required (rare in Biome 2), allow it but log it:
  - `enemy_crossed_lava = true`

### 6.2 Slow terrain
- Slow terrain reduces movement speed:
  - Player: 25% slow (Biome 2 spec) :contentReference[oaicite:9]{index=9}
  - Enemies: apply same 25% slow in Biome 2 (consistent) :contentReference[oaicite:10]{index=10}
...
- Direct chase
- Separation ON
- No circling logic (Biome 2 simple)

### 7.2 Flanker
- Uses “offset target” (angle approach) for 0.8–1.2 sec circle time (deterministic window allowed as fixed constant in Biome 2: **1.0 sec**) :contentReference[oaicite:12]{index=12}
- Then lunge/dash
...
# BIOME 2 — Player Movement Spec (LOCKED, Deterministic)
...
## 1) Player Base Movement (Biome 2)
...
# BIOME 2 — Player Stat Scaling Rules (LOCKED for MVP, RL-Tunable Later)

Tile size: 32×32 px  
Goal:
- Simple, readable upgrades
- No runaway scaling in Biome 2
...
## 1) Base Player Stats (Biome 2 Defaults)
...
- Heal pickups can appear in Safe Room only for Biome 2 MVP
...
## 7) Pickup Spawn Rules (Biome 2 MVP)
...
RL may tune:
- Upgrade spawn frequency (how often safe room appears — already fixed to 1 in Biome 2)
...
- Increase any stat cap beyond Biome 2 limits
...
# BIOME 2 — Enemy HP + Damage Values (LOCKED for MVP, RL-Tunable Later)

Goal:
- Biome 2 teaches patterns without being lethal
...
All values below are for Biome 2 baseline.

---

## 1) Global Combat Rules (Biome 2)
...
### 1.2 Crits
- No critical hits in Biome 2 (keeps balance simple).
...
| Brute (if used) | 50 |
| Elite Guardian | 120 |
| Mini Boss (Biome 2 Guardian) | 320 |
...
### 3.6 Mini Boss (Biome 2 Guardian)
...
## 5) Biome 2 Difficulty Targets (Sanity Check)
...
# BIOME 2 — Enemy Hitboxes, Hurtboxes, and Projectile Specs (LOCKED)
...
## 2) Enemy Body Hurtboxes (Biome 2)
...
### 5.2 Dash Strike
- During dash, boss body is damaging ONLY at end impact (Biome 2 fairness)
Impact hitbox:
- Circle radius: **40 px**
...
# BIOME 2 — Knockback + Stagger / Stun Rules (LOCKED for MVP)

Goal:
- Combat feels responsive
- Hits have impact
- No stun-lock abuse
- Biome 2 emains readable and fair

Tile size: 32×32 px

---

# 1️⃣ Global Philosophy (Biome 2)
...
Biome 2 keeps crowd control simple.
...
Biome 2 minimal knockback to avoid frustration.
...
Mini Boss cannot be staggered in Biome 2 MVP.
...
# BIOME 2 — Wrap-Up (Win Rate Target + Difficulty Curve + RL Metrics)

Biome 2 goal:
- Apply knowledge on combat + hazards + telegraphs
- Be fair and consistent (deterministic)
- Provide good logs for RL to tune later

---

## 1) 🎯 Target Win Rate for Biome 2 (Baseline Before RL)

We will define win rate targets for **two audiences**:

### 1.1 New / Average Player (first-time run)
- Target Biome 2 clear rate: **55% – 65%**
...
## 15) Biome 2 — Room Clear Rule (Hard-Locked)
...
## 16) AI Director — Flexible Slot Rule (Hard-Locked for Biome 2)

- Seed may mark **0 or 1** flexible slot per Biome 2 run.
- **Max flexible slots per run: 1**
- Eligible indices: **Room 11, 12, or 13**
...
# SECTION — Biome 2 Asset Binding Contract (Authoritative)
...
## 3️⃣ Enemy Asset Contract — Biome 2
...
## 1️⃣5️⃣ Mandatory Asset Checklist (Biome 2 MVP)
